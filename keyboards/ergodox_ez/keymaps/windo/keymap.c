...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MOTION] = LAYOUT_ergodox_pretty(
    ...
    KC_TRNS, MSQ_C,   MSQ_L,   MSQ_B,   MSQ_R,   MS_WHLU,                         KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, MSQ_BL, MSQ_DANCE,MSQ_BR,  MS_WHLD, KC_TRNS,       KC_TRNS, KC_END,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,

    KC_TRNS, WEBUSB_PAIR, KC_TRNS, KC_TRNS, KC_TRNS,                                       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,

                                                    MS_BTN3, KC_TRNS,    KC_TRNS, KC_TRNS,
                                                             KC_TRNS,    KC_TRNS,
                                           MS_BTN1, MS_BTN2, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS
  ),
